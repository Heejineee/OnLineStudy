	...
	<div class="container">
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					<td>
						<c:forEach var="vo" items="${list }">	<%-- 이 items=${list}의 값과 RecipeModel에서 보낸 request.setAttribute("list", list); 의 이름이 동일해야 함! --%>
							<table class="table table-striped">
								<tr>
									<td width=35% rowspan=2 class="text-center">
										<img src="${vo.poster }" class="img-circle" width=60 height=60>
									</td>
									<td colspan=4 style="font-size:13pt; color:#fc6; font-weight:bold;">
