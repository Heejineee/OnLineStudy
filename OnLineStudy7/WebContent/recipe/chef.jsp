...
<%
	...
	*/
	...
	// Map에 저장해서 전송(Map은 데이터를 쌍(키, 값)으로 묶어서 저장하는 공간의 클래스)
	Map map=new HashMap();
						...
						%>
								<table class="table table-striped">
									<tr>
										...
										<td colspan=4><font color=orange>
											<a href="chef_list.jsp?chef=<%=vo.getChef()%>"><%=vo.getChef() %></font></a>
										</td>
									</tr>
									<tr>
